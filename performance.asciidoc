...
If you have 1000 hosts in your PatchMon instance for example, the default "max execution time" of 15 would lead to batches of roughly 40 to 70 hosts to be fetched in one special agent invocation.
It would need 15 to 25 subsequent special agent invocations to fetch all 1000 hosts.
This is well lower than the default caching interval of 80 minutes after which the whole procedure starts again.
