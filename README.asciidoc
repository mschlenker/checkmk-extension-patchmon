...
Currently, Checkmk version 2.3.0 to 2.5.0 and PatchMon 1.4.x are supported.
...
For Checkmk Raw/Community, with PatchMon 1.4.2, Iby has added the possibility to download a CSV list of the hosts present in PatchMon for easy import in Checkmk.
