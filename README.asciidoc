...
Support for Checkmk 2.5.0 is beta since this is my first take on playing with the new link:https://docs.checkmk.com/plugin-api/2.5.0/cmk.server_side_programs/index.html#cmk.server_side_programs.v1_unstable.Storage[storage API^].
