...
*Note:* Despite the name of the repository, the core script in this repository has command line switches to behave as link:https://www.monitoring-plugins.org/[monitoring plugin^] for other monitoring systems (e.g. Icinga, LibreNMS, Nagios).
