...
link:./images/create_scoped_credential.png[Screenshot^]
...
link:./images/create_csv_list.png[Screenshot^]
...
link:./images/create_patchmon_host.png[Screenshot^]
...
Clicking it brings you to the link:https://docs.checkmk.com/latest/en/password_store.html[_Password store_^].
...
link:./images/create_password.png[Screenshot^]
...
Clicking it brings you to the configuration of the _PatchMon special agent_ (link:https://docs.checkmk.com/latest/en/special_agents.html[special agents in the User Guide^]).
...
link:./images/create_agent_rule.png[Screenshot^]
...
link:./images/services_server.png[Screenshot^]
...
link:./images/services_host.png[Screenshot^],
link:./images/services_graph.png[Screenshot^]
...
link:./images/configure_monitoring_rule.png[Screenshot^]
